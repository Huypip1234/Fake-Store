...
const Contact = () => {
  return (
    <div className="flex flex-col items-center mt-[4rem]">
      <h1 className="dark:text-white">Get in touch</h1>
      <div className="mt-[2rem] flex flex-col gap-[1.5rem]">
        <a
          className="rounded-full"
          href="https://www.facebook.com/chuhuy69"
          target="_blank"
        >
          <div className="flex items-center bg-primary dark:bg-[#1877F2] dark:drop-shadow-[0px_0px_10px_#1877F2] hover:drop-shadow-[0px_0px_20px_#1877F2] dark:hover:drop-shadow-[0px_0px_20px_#1877F2] hover:bg-[#1877F2] py-[1rem] px-[2rem] rounded-full ease-in-out duration-300">
            <svg
              fill="#000000"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 310 310"
              className="w-[1.5rem] fill-white"
            >
            ...
            <p className="ml-[0.5rem] text-white">facebook.com/chuhuy69</p>
          </div>
        </a>

        <a
          className="rounded-full"
          href="https://www.instagram.com/chuhuyy_01/"
          target="_blank"
        >
          <div className="rounded-full flex items-center py-[1rem] px-[2rem] bg-black dark:backgroundInstagram dark:drop-shadow-[0px_0px_10px_#E1306C] hover:drop-shadow-[0px_0px_20px_#E1306C] dark:hover:drop-shadow-[0px_0px_20px_#E1306C] hover:backgroundInstagram ease-in-out duration-300">
            <svg
              fill="#000000"
              viewBox="0 0 32 32"
              xmlns="http://www.w3.org/2000/svg"
            ...
            <p className="ml-[0.5rem] text-white">instagram.com/chuhuyy_01/</p>
          </div>
        </a>

        <a
          className="rounded-full"
          href="https://www.twitter.com/ChuHuy69"
          target="_blank"
        >
          <div className="flex items-center bg-black hover:bg-[#1DA1F2] py-[1rem] px-[2rem] dark:bg-[#1DA1F2] dark:drop-shadow-[0px_0px_10px_#1DA1F2] hover:drop-shadow-[0px_0px_20px_#1DA1F2] dark:hover:drop-shadow-[0px_0px_20px_#1DA1F2] rounded-full ease-in-out duration-300">
            <svg
              viewBox="0 0 24 24"
              fill="#000000"
              xmlns="http://www.w3.org/2000/svg"
            ...
            <p className="ml-[0.5rem] text-white">twitter.com/ChuHuy69</p>
          </div>
        </a>
      </div>
    </div>
